...
function handleSelect(e){
        setInput({
            ...input,
            temper: input.temper.includes(e.target.value)?input.temper:
            ...
            if(input.min_height<=input.max_height){
              if(input.min_weight!==''){
                if(input.max_weight!==''){
                  if(input.min_weight<=input.max_weight){
                    if(input.min_years!==''){
                      ...
                      return 
                        ...
                        alert('el año minimo debe ser menor o igual al año maximo')
                        return
                      }
                    }
                  ...
                  alert('el peso minimo debe ser menor o igual al peso maximo')
                  return
                }
              ...
              alert('la altura minima debe ser menor o igual a la altura maxima')
              return
            }
...
alert('Los campos Nombre Altura Peso y Temperamentos deben estar completados 😪')
  ...
  <div>
    ...
    <form onSubmit={(e)=>handleSubmit(e) }>
      ...
      <div>
        ...
        <input type="number" value={input.min_height} min='20' max='80' name="min_height" onChange={(e)=>handleChange(e)} />
        {errors.min_height && (<p className="error">{errors.min_height}</p>)}
      </div>
      <div>
        <label >Altura Maxima: </label>
        <input type="number" value={input.max_height} min='30' max="100" name="max_height" onChange={(e)=>handleChange(e)} />
        {errors.max_height && (<p className="error">{errors.max_height}</p>)}
      </div>
      <div>
        <label>Peso Minimo: </label>
        <input type="number" value={input.min_weight} min="3" max="50" name="min_weight" onChange={(e)=>handleChange(e)} />
        {errors.min_weight && (<p className="error">{errors.min_weight}</p>)}
      </div>
      <div>
        <label >Peso Maximo: </label>
        <input type="number" value={input.max_weight} min="60" max="100" name="max_weight" onChange={(e)=>handleChange(e)} />
      ...
      <div>
        ...
        <div>
          ...
          <input type="number" value={input.min_years} min="1" max="3" name="min_years" onChange={(e)=>handleChange(e)} />
          
        </div>
        <div>
          <label>Años de vida Maximo: </label>
          <input type="number" value={input.max_years} min="1" max="20" name="max_years" onChange={(e)=>handleChange(e)} />
        ...
        <div>
          ...
          <option disabled selected >Seleccione el temperamento</option>
          {
            temperaments.map(e=>(
          ...
          <ul><li>{input.temper.map(el=>el+" ,")}</li></ul>
        </div>
